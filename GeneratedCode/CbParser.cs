...
// GPPG version 1.5.0
// Machine:  SUNTORY
// DateTime: 19-Jun-14 21:12:47
// UserName: nigelh
// Input file <CbParser.y - 19-Jun-14 21:12:37>
...
#pragma warning restore 649
  ...
  private static string[] nonTerms = new string[] {
      ...
      "AnInteger", "AChar", "AString", "Qualifiers", };
  ...
  static Parser() {
    ...
    states[14] = new State(new int[]{137,15,154,24,140,30,147,31,135,32,146,183,149,184,143,185},new int[]{-11,33,-14,39,-20,25,-5,28,-21,29});
    ...
    states[39] = new State(new int[]{150,181,154,24,140,30,147,31,135,32},new int[]{-15,40,-11,182,-20,25,-5,28,-21,29});
    states[40] = new State(new int[]{154,24},new int[]{-5,41});
    states[41] = new State(new int[]{40,42});
    states[42] = new State(new int[]{154,24,140,30,147,31,135,32,41,-26},new int[]{-16,43,-18,175,-19,180,-11,178,-20,25,-5,28,-21,29});
    ...
    states[47] = new State(new int[]{125,48,154,24,139,147,151,154,134,159,145,161,123,46,59,166,140,30,147,31,135,32},new int[]{-22,49,-28,50,-23,51,-5,142,-17,165,-20,167,-21,170});
    states[48] = new State(-54);
    states[49] = new State(-59);
    states[50] = new State(-60);
    states[51] = new State(new int[]{61,52,40,134,152,138,153,140});
    states[52] = new State(new int[]{45,82,43,84,154,24,142,105,156,107,155,109,157,113,141,114,40,122},new int[]{-24,53,-29,81,-30,86,-23,87,-5,94,-31,106,-32,108,-33,110});
    ...
    states[55] = new State(new int[]{45,82,43,84,154,24,142,105,156,107,155,109,157,113,141,114,40,122},new int[]{-24,56,-29,81,-30,86,-23,87,-5,94,-31,106,-32,108,-33,110});
    ...
    states[57] = new State(new int[]{45,82,43,84,154,24,142,105,156,107,155,109,157,113,141,114,40,122},new int[]{-24,58,-29,81,-30,86,-23,87,-5,94,-31,106,-32,108,-33,110});
    ...
    states[59] = new State(new int[]{45,82,43,84,154,24,142,105,156,107,155,109,157,113,141,114,40,122},new int[]{-24,60,-29,81,-30,86,-23,87,-5,94,-31,106,-32,108,-33,110});
    ...
    states[61] = new State(new int[]{45,82,43,84,154,24,142,105,156,107,155,109,157,113,141,114,40,122},new int[]{-24,62,-29,81,-30,86,-23,87,-5,94,-31,106,-32,108,-33,110});
    ...
    states[63] = new State(new int[]{45,82,43,84,154,24,142,105,156,107,155,109,157,113,141,114,40,122},new int[]{-24,64,-29,81,-30,86,-23,87,-5,94,-31,106,-32,108,-33,110});
    ...
    states[65] = new State(new int[]{45,82,43,84,154,24,142,105,156,107,155,109,157,113,141,114,40,122},new int[]{-24,66,-29,81,-30,86,-23,87,-5,94,-31,106,-32,108,-33,110});
    ...
    states[67] = new State(new int[]{45,82,43,84,154,24,142,105,156,107,155,109,157,113,141,114,40,122},new int[]{-24,68,-29,81,-30,86,-23,87,-5,94,-31,106,-32,108,-33,110});
    ...
    states[69] = new State(new int[]{45,82,43,84,154,24,142,105,156,107,155,109,157,113,141,114,40,122},new int[]{-24,70,-29,81,-30,86,-23,87,-5,94,-31,106,-32,108,-33,110});
    ...
    states[71] = new State(new int[]{45,82,43,84,154,24,142,105,156,107,155,109,157,113,141,114,40,122},new int[]{-24,72,-29,81,-30,86,-23,87,-5,94,-31,106,-32,108,-33,110});
    ...
    states[73] = new State(new int[]{45,82,43,84,154,24,142,105,156,107,155,109,157,113,141,114,40,122},new int[]{-24,74,-29,81,-30,86,-23,87,-5,94,-31,106,-32,108,-33,110});
    ...
    states[75] = new State(new int[]{45,82,43,84,154,24,142,105,156,107,155,109,157,113,141,114,40,122},new int[]{-24,76,-29,81,-30,86,-23,87,-5,94,-31,106,-32,108,-33,110});
    states[76] = new State(-71);
    states[77] = new State(new int[]{45,82,43,84,154,24,142,105,156,107,155,109,157,113,141,114,40,122},new int[]{-24,78,-29,81,-30,86,-23,87,-5,94,-31,106,-32,108,-33,110});
    states[78] = new State(-72);
    states[79] = new State(new int[]{45,82,43,84,154,24,142,105,156,107,155,109,157,113,141,114,40,122},new int[]{-24,80,-29,81,-30,86,-23,87,-5,94,-31,106,-32,108,-33,110});
    states[80] = new State(-73);
    states[81] = new State(-74);
    states[82] = new State(new int[]{45,82,43,84,154,24,142,105,156,107,155,109,157,113,141,114,40,122},new int[]{-24,83,-29,81,-30,86,-23,87,-5,94,-31,106,-32,108,-33,110});
    ...
    states[84] = new State(new int[]{45,82,43,84,154,24,142,105,156,107,155,109,157,113,141,114,40,122},new int[]{-24,85,-29,81,-30,86,-23,87,-5,94,-31,106,-32,108,-33,110});
    states[85] = new State(new int[]{128,-76,129,-76,130,-76,131,-76,133,-76,60,-76,132,-76,62,-76,43,-76,45,-76,42,75,47,77,37,79,59,-76,44,-76,41,-76,93,-76});
    states[86] = new State(-77);
    states[87] = new State(new int[]{40,88,59,-78,128,-78,129,-78,130,-78,131,-78,133,-78,60,-78,132,-78,62,-78,43,-78,45,-78,42,-78,47,-78,37,-78,44,-78,41,-78,93,-78});
    states[88] = new State(new int[]{45,82,43,84,154,24,142,105,156,107,155,109,157,113,141,114,40,122,41,-50},new int[]{-25,89,-26,91,-24,133,-29,81,-30,86,-23,87,-5,94,-31,106,-32,108,-33,110});
    states[89] = new State(new int[]{41,90});
    states[90] = new State(-79);
    states[91] = new State(new int[]{44,92,41,-51});
    states[92] = new State(new int[]{45,82,43,84,154,24,142,105,156,107,155,109,157,113,141,114,40,122},new int[]{-24,93,-29,81,-30,86,-23,87,-5,94,-31,106,-32,108,-33,110});
    states[93] = new State(new int[]{128,55,129,57,130,59,131,61,133,63,60,65,132,67,62,69,43,71,45,73,42,75,47,77,37,79,44,-52,41,-52});
    states[94] = new State(new int[]{46,96,91,99,40,-95,59,-95,128,-95,129,-95,130,-95,131,-95,133,-95,60,-95,132,-95,62,-95,43,-95,45,-95,42,-95,47,-95,37,-95,44,-95,41,-95,93,-95,61,-95,152,-95,153,-95},new int[]{-34,95});
    states[95] = new State(-91);
    states[96] = new State(new int[]{154,24},new int[]{-5,97});
    states[97] = new State(new int[]{46,96,91,99,40,-95,59,-95,128,-95,129,-95,130,-95,131,-95,133,-95,60,-95,132,-95,62,-95,43,-95,45,-95,42,-95,47,-95,37,-95,44,-95,41,-95,93,-95,61,-95,152,-95,153,-95},new int[]{-34,98});
    states[98] = new State(-92);
    states[99] = new State(new int[]{93,103,45,82,43,84,154,24,142,105,156,107,155,109,157,113,141,114,40,122},new int[]{-24,100,-29,81,-30,86,-23,87,-5,94,-31,106,-32,108,-33,110});
    states[100] = new State(new int[]{93,101,128,55,129,57,130,59,131,61,133,63,60,65,132,67,62,69,43,71,45,73,42,75,47,77,37,79});
    states[101] = new State(new int[]{46,96,91,99,40,-95,59,-95,128,-95,129,-95,130,-95,131,-95,133,-95,60,-95,132,-95,62,-95,43,-95,45,-95,42,-95,47,-95,37,-95,44,-95,41,-95,93,-95,61,-95,152,-95,153,-95},new int[]{-34,102});
    states[102] = new State(-93);
    states[103] = new State(new int[]{46,96,91,99,40,-95,59,-95,128,-95,129,-95,130,-95,131,-95,133,-95,60,-95,132,-95,62,-95,43,-95,45,-95,42,-95,47,-95,37,-95,44,-95,41,-95,93,-95,61,-95,152,-95,153,-95},new int[]{-34,104});
    states[104] = new State(-94);
    states[105] = new State(-80);
    states[106] = new State(-81);
    states[107] = new State(-97);
    states[108] = new State(-82);
    states[109] = new State(-98);
    states[110] = new State(new int[]{46,111,59,-83,128,-83,129,-83,130,-83,131,-83,133,-83,60,-83,132,-83,62,-83,43,-83,45,-83,42,-83,47,-83,37,-83,44,-83,41,-83,93,-83});
    states[111] = new State(new int[]{154,24},new int[]{-5,112});
    states[112] = new State(-84);
    states[113] = new State(-99);
    states[114] = new State(new int[]{154,24,140,30,147,31,135,32},new int[]{-5,115,-20,118,-21,29});
    ...
    states[119] = new State(new int[]{45,82,43,84,154,24,142,105,156,107,155,109,157,113,141,114,40,122},new int[]{-24,120,-29,81,-30,86,-23,87,-5,94,-31,106,-32,108,-33,110});
    states[120] = new State(new int[]{93,121,128,55,129,57,130,59,131,61,133,63,60,65,132,67,62,69,43,71,45,73,42,75,47,77,37,79});
    states[121] = new State(-86);
    states[122] = new State(new int[]{45,82,43,84,154,24,142,105,156,107,155,109,157,113,141,114,40,122,140,30,147,31,135,32},new int[]{-24,123,-21,126,-29,81,-30,86,-23,87,-5,94,-31,106,-32,108,-33,110});
    states[123] = new State(new int[]{41,124,128,55,129,57,130,59,131,61,133,63,60,65,132,67,62,69,43,71,45,73,42,75,47,77,37,79});
    states[124] = new State(new int[]{154,24,142,105,156,107,155,109,157,113,141,114,40,122,59,-87,128,-87,129,-87,130,-87,131,-87,133,-87,60,-87,132,-87,62,-87,43,-87,45,-87,42,-87,47,-87,37,-87,44,-87,41,-87,93,-87},new int[]{-30,125,-23,87,-5,94,-31,106,-32,108,-33,110});
    states[125] = new State(-88);
    states[126] = new State(new int[]{41,127,91,129});
    states[127] = new State(new int[]{154,24,142,105,156,107,155,109,157,113,141,114,40,122},new int[]{-30,128,-23,87,-5,94,-31,106,-32,108,-33,110});
    states[128] = new State(-89);
    states[129] = new State(new int[]{93,130});
    states[130] = new State(new int[]{41,131});
    states[131] = new State(new int[]{154,24,142,105,156,107,155,109,157,113,141,114,40,122},new int[]{-30,132,-23,87,-5,94,-31,106,-32,108,-33,110});
    states[132] = new State(-90);
    states[133] = new State(new int[]{128,55,129,57,130,59,131,61,133,63,60,65,132,67,62,69,43,71,45,73,42,75,47,77,37,79,44,-53,41,-53});
    states[134] = new State(new int[]{45,82,43,84,154,24,142,105,156,107,155,109,157,113,141,114,40,122,41,-50},new int[]{-25,135,-26,91,-24,133,-29,81,-30,86,-23,87,-5,94,-31,106,-32,108,-33,110});
    ...
    states[142] = new State(new int[]{91,143,46,96,154,-33,61,-95,40,-95,152,-95,153,-95},new int[]{-34,95});
    states[143] = new State(new int[]{93,144,45,82,43,84,154,24,142,105,156,107,155,109,157,113,141,114,40,122},new int[]{-24,100,-29,81,-30,86,-23,87,-5,94,-31,106,-32,108,-33,110});
    states[144] = new State(new int[]{154,24,46,96,91,99,61,-95,40,-95,152,-95,153,-95},new int[]{-13,145,-34,104,-5,38});
    states[145] = new State(new int[]{59,146,44,36});
    states[146] = new State(-56);
    states[147] = new State(new int[]{40,148});
    states[148] = new State(new int[]{45,82,43,84,154,24,142,105,156,107,155,109,157,113,141,114,40,122},new int[]{-24,149,-29,81,-30,86,-23,87,-5,94,-31,106,-32,108,-33,110});
    states[149] = new State(new int[]{41,150,128,55,129,57,130,59,131,61,133,63,60,65,132,67,62,69,43,71,45,73,42,75,47,77,37,79});
    states[150] = new State(new int[]{154,24,139,147,151,154,134,159,145,161,123,46,59,166},new int[]{-22,151,-23,51,-5,94,-17,165});
    states[151] = new State(new int[]{138,152,125,-43,154,-43,139,-43,151,-43,134,-43,145,-43,123,-43,59,-43,140,-43,147,-43,135,-43});
    states[152] = new State(new int[]{154,24,139,147,151,154,134,159,145,161,123,46,59,166},new int[]{-22,153,-23,51,-5,94,-17,165});
    states[153] = new State(-42);
    states[154] = new State(new int[]{40,155});
    states[155] = new State(new int[]{45,82,43,84,154,24,142,105,156,107,155,109,157,113,141,114,40,122},new int[]{-24,156,-29,81,-30,86,-23,87,-5,94,-31,106,-32,108,-33,110});
    states[156] = new State(new int[]{41,157,128,55,129,57,130,59,131,61,133,63,60,65,132,67,62,69,43,71,45,73,42,75,47,77,37,79});
    states[157] = new State(new int[]{154,24,139,147,151,154,134,159,145,161,123,46,59,166},new int[]{-22,158,-23,51,-5,94,-17,165});
    states[158] = new State(-44);
    states[159] = new State(new int[]{59,160});
    states[160] = new State(-45);
    states[161] = new State(new int[]{59,162,45,82,43,84,154,24,142,105,156,107,155,109,157,113,141,114,40,122},new int[]{-24,163,-29,81,-30,86,-23,87,-5,94,-31,106,-32,108,-33,110});
    states[162] = new State(-46);
    states[163] = new State(new int[]{59,164,128,55,129,57,130,59,131,61,133,63,60,65,132,67,62,69,43,71,45,73,42,75,47,77,37,79});
    ...
    states[172] = new State(new int[]{154,24},new int[]{-13,173,-5,38});
    states[173] = new State(new int[]{59,174,44,36});
    states[174] = new State(-57);
    states[175] = new State(new int[]{44,176,41,-27});
    states[176] = new State(new int[]{154,24,140,30,147,31,135,32},new int[]{-19,177,-11,178,-20,25,-5,28,-21,29});
    ...
    states[191] = new State(new int[]{154,24},new int[]{-5,192});
    ...
    rules[76] = new Rule(-29, new int[]{43,-24});
    rules[77] = new Rule(-29, new int[]{-30});
    rules[78] = new Rule(-30, new int[]{-23});
    rules[79] = new Rule(-30, new int[]{-23,40,-25,41});
    rules[80] = new Rule(-30, new int[]{142});
    rules[81] = new Rule(-30, new int[]{-31});
    rules[82] = new Rule(-30, new int[]{-32});
    rules[83] = new Rule(-30, new int[]{-33});
    rules[84] = new Rule(-30, new int[]{-33,46,-5});
    rules[85] = new Rule(-30, new int[]{141,-5,40,41});
    rules[86] = new Rule(-30, new int[]{141,-20,91,-24,93});
    rules[87] = new Rule(-30, new int[]{40,-24,41});
    rules[88] = new Rule(-30, new int[]{40,-24,41,-30});
    rules[89] = new Rule(-30, new int[]{40,-21,41,-30});
    rules[90] = new Rule(-30, new int[]{40,-21,91,93,41,-30});
    rules[91] = new Rule(-23, new int[]{-5,-34});
    rules[92] = new Rule(-34, new int[]{46,-5,-34});
    rules[93] = new Rule(-34, new int[]{91,-24,93,-34});
    rules[94] = new Rule(-34, new int[]{91,93,-34});
    rules[95] = new Rule(-34, new int[]{});
    rules[96] = new Rule(-5, new int[]{154});
    rules[97] = new Rule(-31, new int[]{156});
    rules[98] = new Rule(-32, new int[]{155});
    rules[99] = new Rule(-33, new int[]{157});
  }
...
#line 285 "CbParser.y"
{ CurrentSemanticValue = AST.Leaf(NodeType.IntConst, LineNumber, lexer.yytext); }
        break;
